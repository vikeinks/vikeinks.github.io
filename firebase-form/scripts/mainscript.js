  ...
  document.getElementById("vikeForms").addEventListener("submit", function(e){
    e.preventDefault();
      ...
      firebase.auth().signInAnonymously().then(user =>{
        ...
        htmlText += name + '</div><div class="col-sm-5"> Order Date Required: ' + daterequired + '</div></div><div class="row"> <div class=" col-sm-offset-1 col-sm-11"> Email Address: ' + customerEmail +'</div></div></div>'; /*+ " &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp" + orderValue;*/
